...
| **Bloque del Lean UX Canvas** | **Aplicación en ColdTrack** |
| --- | --- |
| **Business Problem** | Las empresas distribuidoras de alimentos que realizan transporte refrigerado no siempre cuentan con información oportuna y trazable sobre temperatura y humedad durante la ruta. Esto puede generar reacción tardía ante incidencias, pérdida de productos, baja confianza en el proceso y dificultad para sustentar decisiones de calidad. |
| **Business Outcomes** | Reducir la incertidumbre operativa durante el transporte, disminuir la dependencia de registros manuales, mejorar la trazabilidad de incidentes, aumentar la rapidez de respuesta ante alertas y fortalecer la confianza en el control de calidad del envío. |
| **Users** | Supervisores logísticos, responsables de control de calidad y conductores vinculados al transporte de alimentos refrigerados o productos sensibles. |
| **User Outcomes & Benefits** | Los supervisores podrán priorizar envíos en riesgo; el personal de calidad podrá revisar evidencia histórica; los conductores podrán entender cuándo deben actuar; la empresa podrá tomar decisiones con información más clara y confiable. |
| **Solutions** | MVP compuesto por Landing Page, Web Application, autenticación, registro de envíos, sensores, lecturas de temperatura y humedad, alertas, historial y reportes PDF. La integración con sensores físicos reales queda como evolución futura. |
| **Hypotheses** | Si los usuarios pueden detectar un envío en riesgo, interpretar una alerta y consultar historial sin ayuda constante, entonces ColdTrack puede mejorar la toma de decisiones durante la cadena de frío. |
| **What is the most important thing we need to learn first?** | Necesitamos aprender si los supervisores logísticos pueden detectar y priorizar un envío en riesgo usando ColdTrack más rápido y con mayor claridad que con sus métodos actuales. |
| **What is the least amount of work we need to do to learn it?** | Construir y probar un flujo mínimo con dashboard, detalle de envío, lectura simulada, alerta visible e historial básico para observar si el usuario entiende el riesgo y decide una acción. |
